...
describe("Users", () => {
  ...
  it("GET /universes/{id}/user-restrictions", async () => {
    ...
    const result = await openCloud.users.listUserRestrictions("123", {
      maxPageSize: 10,
    });
  ...
  it("PATCH /universes/{id}/user-restrictions/{userId} with valid updateMask", async () => {
    ...
    const result = await openCloud.users.updateUserRestriction(
      "123",
      "1",
      body,
  ...
  it("PATCH /universes/{id}/user-restrictions/{userId} invalid updateMask throws", async () => {
    ...
    await expect(
      openCloud.users.updateUserRestriction("123", "1", body, "invalid"),
    ).rejects.toThrow();
  });
  ...
  it("GET /universes/{id}/user-restrictions:listLogs", async () => {
    ...
    const result = await openCloud.users.listUserRestrictionLogs("123", {
      maxPageSize: 10,
    });
